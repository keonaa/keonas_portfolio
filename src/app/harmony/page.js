...
export default function Harmony() {
  return (
    <div className={styles.harmonyPage}>
      {/* Hero Section */}
      <section className={styles.heroSection}>
        <h1 className={styles.title}>Harmony</h1>
        <Chips items={["UI/UX", "Mobile Design", "Case Study"]} />
        <Image
          src="/images/harmony_banner.png"
      ...
      <section className={styles.aboutContainer}>
        ...
        <div className={styles.personas}>
          <Image src="/images/persona_maria.png" alt="User Persona 1" width={600} height={700} />
          <Image src="/images/persona_david.png" alt="User Persona 2" width={600} height={700} />
        </div>
      </section>
      ...
      <section className={styles.aboutContainer}>
        ...
        <div className={styles.videoContainer}>
          <iframe
            src="https://embed-url-for-userflow.com"
            width="100%"
            height="600"
            allowFullScreen
            title="User Flow"
      ...
      <section className={styles.aboutContainer}>
        ...
        <Image src="/images/lofi_1.png" alt="Lo-Fi Screens 1" width={1200} height={700} />
        <Image src="/images/lofi_2.png" alt="Lo-Fi Screens 2" width={1200} height={700} />
        <Image src="/images/lofi_3.png" alt="Lo-Fi Screens 3" width={1200} height={700} />
      </section>
      ...
      <section className={styles.aboutContainer}>
        ...
        <Image src="/images/styleguide_1.png" alt="Style Guide 1" width={1200} height={700} />
        <Image src="/images/styleguide_2.png" alt="Style Guide 2" width={1200} height={700} />
      </section>
      ...
      <section className={styles.aboutContainer}>
        ...
        <Image src="/images/finaldesign.png" alt="Final Design Screens" width={1400} height={800} />
      </section>
    </div>
  );
}
